  ...
  const tariff = [
    {
      ...
      id: 1,
      title: "Beginner",
      image: '/Logo/Tariff/beginner.svg',
    ...
    },
    {
      ...
      id: 3,
      title: "Business",
      image: '/Logo/Tariff/business.svg',
        ...
        <div className="tariff" key={item.id}>
          ...
          >
            ...
            <li className="tariff-info">
              <img className="tariff-info__check" src='/Logo/Tariff/checkpoint.svg' alt="" />

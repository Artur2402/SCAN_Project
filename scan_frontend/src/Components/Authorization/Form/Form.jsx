...
const Form = observer(() => {
  ...
  return (
      <form className="form" onSubmit={handleSubmit(onSubmit)}>
        <img className="form-img__lock" src='/Logo/Auth/lock.svg' alt="" />
        ...
        <div className="sign-socials">
          <Link to="https://google.com" target="_blank">
            <img src='/Logo/Auth/google.svg' alt="" />
          </Link>
          <Link to="https://facebook.com" target="_blank">
            <img src='/Logo/Auth/facebook.svg' alt="" />
          </Link>
          <Link to="https://yandex.ru" target="_blank">
            <img src='/Logo/Auth/yandex.svg' alt="" />
          </Link>
        </div>
      </form>
  );
